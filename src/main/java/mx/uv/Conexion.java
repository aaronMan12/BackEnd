...
public class Conexion {
    private static String driverName = "com.mysql.cj.jdbc.Driver";// com.mysql.cj.jdbc.Drivercom.mysql.jdbc.Driver
    ...
    public static Connection getConnection() {
        try {
            ...
            connection = (Connection) DriverManager.getConnection(aceeso);
